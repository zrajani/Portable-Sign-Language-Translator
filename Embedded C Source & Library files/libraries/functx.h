...
//->contains interface for the keypad, ADC, eeprom read/write and battery level indicator 
...
vin+=1.7;                  //diode IN4007 voltage drop adjustment

if(vin < 9.5){glcd_putchar(1,112,0);}
if(vin > 9.5){glcd_putchar(2,112,0);}
if(vin > 10.8){glcd_putchar(3,112,0);}
if(vin > 11.6){glcd_putchar(4,112,0);}
if(vin > 12.4){glcd_putchar(5,112,0);}
if(vin > 13.2){glcd_putchar(6,112,0);}
